class TyposquatDetector:
    ...
    POPULAR_PACKAGES = [
        ...
        "angular", "webpack", "babel", "jest", "mocha",
        "mongoose", "bcrypt", "jsonwebtoken", "dotenv",
        "moment", "chalk", "commander", "inquirer", "debug",
        "request", "async", "underscore", "bluebird", "q",
        "socket.io", "passport", "cors", "helmet", "morgan",
        "nodemon", "pm2", "sequelize", "knex", "typeorm",
        "redis", "mongodb", "mysql", "pg", "sqlite3"
    ]
